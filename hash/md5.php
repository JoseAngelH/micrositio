...
<body>
    ...
    <ul class="nav nav-tabs">
        ...
        <li>
            ...
            style="border-color: transparent; color: #0D6EFD" onchange="location = this.value">
                ...
                <option value="sha1.php">Hash v2 SHA1</option>
            </select>
        </li>
        <li class="nav-item">
        ...
        <div class="card" style="background-color: #D7D4D4;">
            ...
            <div class="card-body">
                <table class="table table-responsive">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT*FROM users where type_encryption = 'MDC';";
                ...
                <a href="adduser.php?tipo=2" class="btn btn-success">Nuevo</a>
            </div>
        </div>
    </div><br>
    ...
    <div class="container">
        <div class="card" style="background-color: #D7D4D4;">
            <div class="card-header">
                <h2>Buscar Usuario --> Cifrado MD5</h2>
            </div>
            <form method="post">
                <div class="card-body">
                    <div class="mb-1">
