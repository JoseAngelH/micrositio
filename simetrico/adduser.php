    ...
    <div class="container">
        <div class="card" style="background-color: #D7D4D4;">
            <div class="card-header">
                <h2>Insertar Usuario --> Cifrado AES</h2>
            </div>
            <form action="../functions.php" method="post">
                <div class="card-body">
                    ...
                    <div class="mb-1">
                        <label for="clave" class="form-label">Clave De Cifrado</label>
                        <input style="background-color: #D7D4D4; border-color:darkgrey" type="password" 
                        class="form-control" id="clave" placeholder="Ingrese una clave" name="clave" required>
                    </div> <br>
                    <input type="hidden" name="tipo" id="tipo" value=0>
                    <input type="submit" value="Guardar" class="btn btn-success">
                    <a href="simetrico.php" class="btn btn-danger">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
